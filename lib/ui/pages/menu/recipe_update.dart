...
import 'package:pocketrecipe_client/controllers/recipe_update_ctrl.dart';

class RecipeUpdatePage extends StatelessWidget {
  RecipeUpdatePage({Key? key}) : super(key: key);
  final controller = Get.put(RecipeUpdateCtrl());
...
//                                 //먼저 전부 초기화
//                                 for (int i = 0;
//                                     i < controller.recipeList.length;
//                                     i++) {
//                                   controller.recipeList.value[i].isUpdate =
//                                       false;
//                                 }
//                                 //선택한 레시피만 체크표시
//                                 controller.recipeList.value[index].isUpdate =
//                                     check!;
...
//                         hintText: "레시피 이름", border: OutlineInputBorder()),
//                     onChanged: (str) {
...
//                       decoration: InputDecoration(
//                           hintText: "칼로리(kcal)", border: OutlineInputBorder()),
//                       onChanged: (str) {
...
//                       decoration: InputDecoration(
//                           hintText: "나트륨(mg)", border: OutlineInputBorder()),
//                       onChanged: (str) {
...
//                       decoration: InputDecoration(
//                           hintText: "탄수화물(g)", border: OutlineInputBorder()),
//                       onChanged: (str) {
...
//                       decoration: InputDecoration(
//                           hintText: "지방(g)", border: OutlineInputBorder()),
//                       onChanged: (str) {
...
//                       decoration: InputDecoration(
//                           hintText: "단백질(g)", border: OutlineInputBorder()),
//                       onChanged: (str) {
